import{u as X,a as ee,m as le,g as E,V as ae,b as Y}from"./VSliderTrack-D4-Yzgd3.js";import{V as Z,m as te}from"./VInput-CTSxe1am.js";import{u as se,m as ue,V as oe}from"./form-Dca2QsTl.js";import{am as ne,$ as re,r as g,aF as ie,aE as de,V as q,a4 as ce,b as t,p as me,F as pe,f as h,o as R,aU as $,l as f,e as c,Z as ve,d,s as v}from"./main-DFArCsHY.js";import{_ as fe}from"./AppCardCode-M-WjixHI.js";import{V as Ve,a as k}from"./VRow-ug2wovWp.js";import"./VImg-u4PCXAxX.js";import"./vue3-perfect-scrollbar-lX5i4by-.js";import"./VCard-DxEjI5j5.js";import"./VAvatar-CR6ulyn0.js";import"./VCardText-DPCtp8hQ.js";import"./VDivider-r3A3xjrj.js";/* empty css              */const be=re({...ue(),...te(),...le(),strict:Boolean,modelValue:{type:Array,default:()=>[0,0]}},"VRangeSlider"),x=ne()({name:"VRangeSlider",props:be(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,end:e=>!0,start:e=>!0},setup(e,u){let{slots:l,emit:o}=u;const a=g(),i=g(),S=g(),{rtlClasses:j}=ie();function I(m){if(!a.value||!i.value)return;const p=E(m,a.value.$el,e.direction),r=E(m,i.value.$el,e.direction),n=Math.abs(p),V=Math.abs(r);return n<V||n===V&&p<0?a.value.$el:i.value.$el}const P=X(e),s=de(e,"modelValue",void 0,m=>m!=null&&m.length?m.map(p=>P.roundValue(p)):[0,0]),{activeThumbRef:b,hasLabels:G,max:B,min:y,mousePressed:H,onSliderMousedown:J,onSliderTouchstart:K,position:z,trackContainerRef:Q,readonly:L}=ee({props:e,steps:P,onSliderStart:()=>{o("start",s.value)},onSliderEnd:m=>{var n;let{value:p}=m;const r=b.value===((n=a.value)==null?void 0:n.$el)?[p,s.value[1]]:[s.value[0],p];!e.strict&&r[0]<r[1]&&(s.value=r),o("end",s.value)},onSliderMove:m=>{var V,w,D,_;let{value:p}=m;const[r,n]=s.value;!e.strict&&r===n&&r!==y.value&&(b.value=p>r?(V=i.value)==null?void 0:V.$el:(w=a.value)==null?void 0:w.$el,(D=b.value)==null||D.focus()),b.value===((_=a.value)==null?void 0:_.$el)?s.value=[Math.min(p,n),n]:s.value=[r,Math.max(r,p)]},getActiveThumb:I}),{isFocused:M,focus:A,blur:N}=se(e),O=q(()=>z(s.value[0])),W=q(()=>z(s.value[1]));return ce(()=>{const m=Z.filterProps(e),p=!!(e.label||l.label||l.prepend);return t(Z,me({class:["v-slider","v-range-slider",{"v-slider--has-labels":!!l["tick-label"]||G.value,"v-slider--focused":M.value,"v-slider--pressed":H.value,"v-slider--disabled":e.disabled},j.value,e.class],style:e.style,ref:S},m,{focused:M.value}),{...l,prepend:p?r=>{var n,V;return t(pe,null,[((n=l.label)==null?void 0:n.call(l,r))??(e.label?t(oe,{class:"v-slider__label",text:e.label},null):void 0),(V=l.prepend)==null?void 0:V.call(l,r)])}:void 0,default:r=>{var w,D;let{id:n,messagesId:V}=r;return t("div",{class:"v-slider__container",onMousedown:L.value?void 0:J,onTouchstartPassive:L.value?void 0:K},[t("input",{id:`${n.value}_start`,name:e.name||n.value,disabled:!!e.disabled,readonly:!!e.readonly,tabindex:"-1",value:s.value[0]},null),t("input",{id:`${n.value}_stop`,name:e.name||n.value,disabled:!!e.disabled,readonly:!!e.readonly,tabindex:"-1",value:s.value[1]},null),t(ae,{ref:Q,start:O.value,stop:W.value},{"tick-label":l["tick-label"]}),t(Y,{ref:a,"aria-describedby":V.value,focused:M&&b.value===((w=a.value)==null?void 0:w.$el),modelValue:s.value[0],"onUpdate:modelValue":_=>s.value=[_,s.value[1]],onFocus:_=>{var T,F,U,C;A(),b.value=(T=a.value)==null?void 0:T.$el,B.value!==y.value&&s.value[0]===s.value[1]&&s.value[1]===y.value&&_.relatedTarget!==((F=i.value)==null?void 0:F.$el)&&((U=a.value)==null||U.$el.blur(),(C=i.value)==null||C.$el.focus())},onBlur:()=>{N(),b.value=void 0},min:y.value,max:s.value[1],position:O.value,ripple:e.ripple},{"thumb-label":l["thumb-label"]}),t(Y,{ref:i,"aria-describedby":V.value,focused:M&&b.value===((D=i.value)==null?void 0:D.$el),modelValue:s.value[1],"onUpdate:modelValue":_=>s.value=[s.value[0],_],onFocus:_=>{var T,F,U,C;A(),b.value=(T=i.value)==null?void 0:T.$el,B.value!==y.value&&s.value[0]===s.value[1]&&s.value[0]===B.value&&_.relatedTarget!==((F=a.value)==null?void 0:F.$el)&&((U=i.value)==null||U.$el.blur(),(C=a.value)==null||C.$el.focus())},onBlur:()=>{N(),b.value=void 0},min:s.value[0],max:B.value,position:W.value,ripple:e.ripple},{"thumb-label":l["thumb-label"]})])}})}),{}}}),_e={__name:"DemoRangeSliderVertical",setup(e){const u=g([20,40]);return(l,o)=>(R(),h(x,{modelValue:f(u),"onUpdate:modelValue":o[0]||(o[0]=a=>$(u)?u.value=a:null),direction:"vertical"},null,8,["modelValue"]))}},ge={__name:"DemoRangeSliderThumbLabel",setup(e){const u=["Winter","Spring","Summer","Fall"],l=["tabler-snowflake","tabler-leaf","tabler-flame","tabler-droplet"],o=g([1,2]);return(a,i)=>(R(),h(x,{modelValue:f(o),"onUpdate:modelValue":i[0]||(i[0]=S=>$(o)?o.value=S:null),tick:u,min:"0",max:"3",step:1,"show-ticks":"always","thumb-label":"","tick-size":"4"},{"thumb-label":c(({modelValue:S})=>[t(ve,{icon:l[S]},null,8,["icon"])]),_:1},8,["modelValue"]))}},Se={__name:"DemoRangeSliderStep",setup(e){const u=g([20,40]);return(l,o)=>(R(),h(x,{modelValue:f(u),"onUpdate:modelValue":o[0]||(o[0]=a=>$(u)?u.value=a:null),step:"10"},null,8,["modelValue"]))}},he={__name:"DemoRangeSliderColor",setup(e){const u=g([10,60]);return(l,o)=>(R(),h(x,{modelValue:f(u),"onUpdate:modelValue":o[0]||(o[0]=a=>$(u)?u.value=a:null),color:"success"},null,8,["modelValue"]))}},Re={__name:"DemoRangeSliderDisabled",setup(e){const u=g([30,60]);return(l,o)=>(R(),h(x,{modelValue:f(u),"onUpdate:modelValue":o[0]||(o[0]=a=>$(u)?u.value=a:null),disabled:"",label:"Disabled"},null,8,["modelValue"]))}},ke={__name:"DemoRangeSliderBasic",setup(e){const u=g([10,60]);return(l,o)=>(R(),h(x,{modelValue:f(u),"onUpdate:modelValue":o[0]||(o[0]=a=>$(u)?u.value=a:null)},null,8,["modelValue"]))}},$e={ts:`<script setup lang="ts">
